  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div>
          <button className="bg-primary/10 text-primary border border-primary/20 px-4 py-2 rounded-md text-sm font-semibold hover:bg-primary/20 hover:border-primary/50 transition-all shadow-[0_0_15px_rgba(0,255,136,0.1)] hover:shadow-[0_0_20px_rgba(0,255,136,0.2)]">
            Install Extension
          </button>
        </div>
      </div>
