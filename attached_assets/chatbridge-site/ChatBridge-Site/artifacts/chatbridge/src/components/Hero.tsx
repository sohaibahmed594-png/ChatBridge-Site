  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center pt-20 overflow-hidden" id="hero">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
        ...
        >
          <button className="group relative px-8 py-4 bg-primary text-primary-foreground font-bold rounded-lg overflow-hidden transition-all hover:scale-105 shadow-[0_0_40px_rgba(0,255,136,0.3)] hover:shadow-[0_0_60px_rgba(0,255,136,0.5)] flex items-center gap-3 w-full sm:w-auto justify-center">
